...
//   let gui = new dat.GUI();
  ...
  function domIsReady() {
      world = new World(this.container, this.renderer, document.querySelector(".gradient").clientWidth, document.querySelector(".gradient").clientHeight);
...
/*   function initGui(){
  ...
  function handleWindowResize() {
      world.updateSize(document.querySelector(".gradient").clientWidth, document.querySelector(".gradient").clientHeight);
  }
  
  function handleMouseMove(e) {
      mousePos.x = e.clientX;
      mousePos.y = e.clientY;
      mousePos.px = mousePos.x / document.querySelector(".gradient").clientWidth;
      mousePos.py = 1.0 - mousePos.y / document.querySelector(".gradient").clientHeight;
