...
//     //world.plane.material.uniforms.uGradient.value = parameters.overlay;
...
//     world.updateSize(document.querySelector(".overlay").clientWidth, document.querySelector(".overlay").clientHeight);
// }
//
// function handleMouseMove(e) {
//     mousePos.x = e.clientX;
//     mousePos.y = e.clientY;
//     mousePos.px = mousePos.x / document.querySelector(".overlay").clientWidth;
//     mousePos.py = 1.0 - mousePos.y / document.querySelector(".overlay").clientHeight;
